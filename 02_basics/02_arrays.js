...
const animated_heros = ["Chota Bheem",["Doraemon",["Shinchan","Pokemon"]],"Hattori"]

const all_heros = marvel_heros.concat(dc_heros,animated_heros)
// console.log(all_heros.flat(2));
...
const letJustFlatTheAboveArray  = anotherArray.flat(3);
// console.log(letJustFlatTheAboveArray);

const mArr = new Array(2,3,3,4);
// #isArray
// console.log(mArr)
// console.log(mArr.isArr(mArr));

// of,from


const grades = [87,98,99,98,34,56,45,67];
const newArr = grades.filter((grade)=>{
    return grade > 60
})
console.log(newArr);